...
public class ADailyTalk implements Serializable {
	...
	public ADailyTalk(Integer id, String name, String knowledge, Date speakdate,
			Integer status, String assessment, String remark) {
		this.id = id;
		this.name = name;
	...
	public ADailyTalk(Integer id, String name, String knowledge, Date speakdate,
			Integer status, String assessment, String remark,String descript) {
		this.id = id;
		this.name = name;
		this.knowledge = knowledge;
		this.speakdate = speakdate;
	...
	// if(speakdate!=null&&!"".equals(speakdate)&&speakdate.indexOf(" ")>=0){
	// return speakdate.substring(0,speakdate.indexOf(" "));
	// }else{
	// return speakdate;
	// }
	// }
