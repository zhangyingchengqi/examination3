...
public class SystemUserAction extends BaseAction {
	...
	public void addUserInfo(){
		...
		try {
			...
			String password=Encrypt.md5AndSha2(newPassword);
	...
	public void checkOldPassword(){
			...
			int flag=-1;
			try {
				oldPassword=Encrypt.md5AndSha2(oldPassword);
	 ...
	 */
		public void updatePasswordById(){
				String jsonStr="";
				try {
					newPassword=Encrypt.md5AndSha2(newPassword);
					SystemUser su=new SystemUser();
					su.setId(userId);
	 ...
	 */
		...
		public void showTeacherInfo(){
            String jsonStr="";
            try {
                List<SystemUser> lists=systemUserBiz.searchTeacherInfo();
