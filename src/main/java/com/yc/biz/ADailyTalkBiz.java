...
public interface ADailyTalkBiz {
	...
	public List<ADailyTalk> findHistoryADailyTalkByCid(int cid,int status, Integer offset, Integer length);
		 ...
		 * @return
		 */
		public List<ADailyTalk> findADailyTalkBypages(int cid,
				String uname,int pageNo, int pageSize);
		 ...
		 * @return
		 */
		public List<ADailyTalk> findADailyTalkByAllToTeacher(int cid,
				String uname,String startDate,String endDate);
		 ...
		 * @return
		 */
		public List<ADailyTalk> findADailyTalkByPageAll(int cid,
				String uname,String startDate,String endDate);
		 ...
		 * @return
		 */
		public List<ADailyTalk> findADailyTalkByMePageAll(int cid,
				String uname,String startDate,String endDate);
		 ...
		 * @return
		 */
		public List<ADailyTalk> findADailyTalkBytime(int cid,
				String uname,String startDate,String endDate,String stuname,int pageNo, int pageSize);
		
		public List<ADailyTalk> findADailyTalkSize(int cid,
				String uname,String startDate,String endDate,String stuname);
}
