...
public class PointInfoBizImpl implements PointInfoBiz {
	...
	@Override
    public List<PointInfo> findPointAllInfoByCids(List<Chapter> cs) {
        String hql="from PointInfo where chapter in (:cs)";
        List<PointInfo> listPointInfo=baseDao.searchByList(hql, cs,"cs");
        return listPointInfo;
    }
}
