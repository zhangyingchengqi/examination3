	...
	$.post("/Examination2.0/checking_showAllCheckingInfo.action",
			...
			{cid:cid,startDate:startDate,endDate:endDate,dateTime:dateTime},function(data){
				...
				if(obj!=null  &&  obj.length>0){
					str = "<table id='mytable' width='1000px' border='1' cellpadding='1'  bgcolor='#EDECEB' bordercolor='#FFFFFF' cellspacing='0'>";
...
//	alert(cid);
	...
	$.post("/Examination2.0/checking_subChecking.action",
			{className:cid,checkDate:date,checkTime:time,checkRemark:remark,semester:semester,checkResult:resultInfo,userName:userName},function(json){
				var obj=$.parseJSON(json);
